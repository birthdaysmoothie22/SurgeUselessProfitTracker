...
def calculateSurgeProfits(wallet_address, surge_token):
	...
	for token in surge_transactions:
		...
		current_underlying_asset_value = 0
		overall_underlying_asset_reflections = 0
		...
		if remaining_tokens > 0:
			...
			overall_underlying_asset_reflections = current_value_of_surge_underlying_asset - total_underlying_asset_value_purchased
		else:
		...
		result[token]['overall_underlying_asset_reflections'] = "{:,.5f}".format(overall_underlying_asset_reflections)
